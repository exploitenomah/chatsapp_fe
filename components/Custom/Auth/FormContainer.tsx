  ...
  return (
    <>
      <Modal show={show} keepMounted={false} hide={hide} animate={true}>
        <div
          data-test-id={testId}
          className='bg-primary-default brightness-105 pt-8 pb-12 px-4 flex flex-col w-[90vw] max-w-md rounded-lg animate-fade-in relative'
        >
